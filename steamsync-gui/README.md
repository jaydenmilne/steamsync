...
You can either use the app, described below, or the [CLI version](../steamsync/README.md) 
...
## Using The App
### Installation
Head over to [the latest GUI release](https://github.com/jaydenmilne/steamsync/releases/tag/0.3.0) and 
